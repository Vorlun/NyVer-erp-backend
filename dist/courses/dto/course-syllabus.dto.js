...
], CreateCourseSyllabusDto.prototype, "lessonOrder", void 0);
__decorate([
    ApiProperty({ description: 'Mavzu' }),
    IsNotEmpty(),
    IsString(),
    __metadata("design:type", String)
], CreateCourseSyllabusDto.prototype, "topic", void 0);
__decorate([
    ApiProperty({ description: 'Tavsif', required: false }),
    IsOptional(),
    IsString(),
    __metadata("design:type", String)
], CreateCourseSyllabusDto.prototype, "description", void 0);
export class UpdateCourseSyllabusDto extends PartialType(CreateCourseSyllabusDto) {
}
//# sourceMappingURL=course-syllabus.dto.js.map